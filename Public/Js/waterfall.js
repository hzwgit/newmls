$( window ).on( "load", function(){
   ...
   var $i = 0;
   console.log($( '.sidebar_rec' ).height())
    ...
    window.onscroll=function(){
        ...
        if(checkscrollside()){
			...
			$.get('/project/index.php/Home/Guang/waterPage',{id:$id,pid:$pid,page:$i},function(dataInt){
				console.log(dataInt)
				if(dataInt){
					data(dataInt);
				}
                        ...
                        +'<div class="new_poster">'
                            ...
                            +' <div class="clear_f"></div>  '
                             +'<div class="comm_num twiiter_box">  '
                                 +'<a class="pl" href="#" target="_blank">销量（'+value.gbuy+'）</a>  '
