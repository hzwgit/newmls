...
<script src="/Project/Public/Js/hotWaterfall.js"></script>
...
<script>
	$(function(){
		...
		$(".cata_types > li :eq("+act+")").attr('class','active  first');
		//置顶按钮
...
<div class="content_fluid" style="width:1200px;">
    <div  id="main" class="goods_wall" style="width: 100%; position: relative;">	
        <div style="" class="corner_notic pin"> 
            <div class="sidebar_rec" style="height:486px;"> 
				<?php if(is_array($cata)): $i = 0; $__LIST__ = $cata;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$ca): $mod = ($i % 2 );++$i;?><div class="list"> 	
						<div class="item"> 
							<h3> 
								<span class="red_f"> <img src="/Project/Mls/Home/Public/Images/29de71e358db368966393442b350_18_18.c8.png" /><?php echo ($ca["name"]); ?></span> 
							</h3> 
							<div class="cont listP" flag="<?php echo ($ca["id"]); ?>"> 
								<!-- <a class="red_f" target="_blank" href=""> 全球潮款 </a>  -->
							</div> 
        ...
        <div coli="0" col="1" style="width: 960px;float:left;" class="corner_nav"> 
            <ul class="cata_types"> 
                <li><a class="" href="/Project/index.php/Home/Guang/hot">流行</a></li> 
                <li><a class="" href="/Project/index.php/Home/Guang/popular">热销</a></li> 
                <li><a class=" " href="/Project/index.php/Home/Guang/newGood">上新</a></li> 
               <!--  <li class="last"><a target="_blank" href="">夏季新品</a></li>  -->
            </ul> 
        </div>


        <?php if(is_array($result)): $i = 0; $__LIST__ = $result;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$res): $mod = ($i % 2 );++$i;?><div class="pin poster_grid retsop poster_wall"> 
            <div class="new_poster"> 
                <div class="np_pic hover_pic"> 
                    <div class="price">
                        <?php echo ($res["gprice"]); ?>
                    </div> 
                    <a class="pic_load" href="/Project/index.php/Home/Share/index/id/<?php echo ($res["gid"]); ?>" target="_blank" title="<?php echo ($res["gname"]); ?>"><img class="goods_pic" src="/Project/Public/<?php echo ($res["gpic"]); ?>" alt="<?php echo ($res["gname"]); ?>" width="226" /></a> 
                ...
                <div class="title"> 
                    <p><a href="/Project/index.php/Home/Share/index/id/<?php echo ($res["gid"]); ?>" target="_blank"><?php echo ($res["gname"]); ?></a></p> 
                </div> 
                <div class="clear_f"></div> 
                <div class="comm_num twiiter_box"> 
                    <a class="pl" href="/Project/index.php/Home/Share/index/id/<?php echo ($res["gid"]); ?>" target="_blank">销量（<?php echo ($res["gbuy"]); ?>）</a> 
                ...
                <div class="np_share comment_panel"> 
                    ...
                    <p class="commentHover t_idt"><?php echo ($res["gsa"]); ?></p> 
                    <div class="clear_f"></div> 
                </div> 
            </div>
        </div><?php endforeach; endif; else: echo "" ;endif; ?>
