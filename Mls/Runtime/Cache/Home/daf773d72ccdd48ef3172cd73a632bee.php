...
<script type="text/javascript" src="/Project/Mls/Home/Public/Js/person.js"></script>    
 
<div class="settings">
    <div class="hp_tab">
        <div class="use-info">
            <img src="<?php echo ($user["pic"]); ?>" alt="" class="use-pic">
        ...
        <div class="sub_tab">
            <ul class="account-manage"> <strong>账号管理</strong>
                <li>
                    <a href="<?php echo U('Person/index');?>" class="red_f">我的信息</a>
                </li>
                <li>
    ...
    <div class="settings_box">
        ...
        <fieldset class="setPassword">
            <form id="setPersonForm" method="post" onsubmit="return false" action="">
                ...
                <p class="form-list">
                    <label>注册邮箱 </label>
                    <input id="register_mail" name="register_mail" autocomplete="off" class="l_ipt" value="#cfd234f6ee30e955f736d745d67a94" disabled="disabled" type="text">
                    <strong></strong>
                </p>
                <p class="form-list">
                    <label>真实姓名</label>
                    <input id="true_name" name="true_name" autocomplete="off" class="l_ipt" value="<?php echo ($user["truename"]); ?>" type="text">
                    <strong></strong>
                </p>

                <p class="form-list">
                    <label>昵称</label>
                    <input id="nickname" name="nickname" autocomplete="off" class="l_ipt" value="<?php echo (session('homename')); ?>" type="text">
                    <strong></strong>
                    <a class="visit_icon"></a>
                </p>
                <p class="passChange">
                <label> 性别 </label>
                    <label  ><input type="radio"  checked="checked"value="0" name="gender">
                 女 </label>
                ...
                <label style="width:15px;float:none;"></label>
                <p class="form-list">
                <label>生日</label>
                    <div class="controls input-append date form_date" data-date="" data-date-format="yyyy MM dd" data-link-field="dtp_input2" data-link-format="yyyy-mm-dd">
                <input size="16"name="birth" type="text" value="<?php echo (date('Y-m-d',$user["birth"])); ?>" readonly>
                ...
                <p class="form-list"style="margin-top: 0px; margin-bottom: 15px;">
                    <label>所在地</label>
                      <input id=""  autocomplete="off" class="l_ipt" value="<?php echo ($user["address"]); ?>" type="text"><br/>
                    <p style="margin-left: 183px; margin-bottom: 15px;">
                ...
                <p class="form-list">
                    <label>学校</label>
                    <input id="school_id" name="school_id" autocomplete="off" class="l_ipt" value="<?php echo ($user["school"]); ?>" type="text">
                    <strong></strong>
                </p>
                <p class="form-list">
                    <label>工作单位</label>
                    <input id="work_place" name="work_place" autocomplete="off" class="l_ipt" value="<?php echo ($user["workunit"]); ?>" type="text">
                    <strong></strong>
                </p>
                <!-- <p class="form-list">
                    <label>从事行业</label>
                    <select name="occupation" id="occupation">
                        ...
                        <option value="1">公关</option>
                        <option value="2">媒体</option>
                        <option value="3">模特</option>
                        <option value="4">设计师</option>
                        <option value="5">市场/营销</option>
                        <option value="6">创意/文案</option>
                        <option value="7">广告</option>
                        <option value="8">法律</option>
                        <option value="9">贸易</option>
                        <option value="10">公务员</option>
                        <option value="11">教育</option>
                        <option value="12">互联网</option>
                        <option value="13">计算机</option>
                        <option value="14">自由职业</option>
                        <option value="15">学生</option>
                        <option value="16">非盈利机构</option>
                        <option value="17">保险</option>
                        <option value="18">财务</option>
                        <option value="19">餐饮</option>
                        <option value="20">电子/微电子</option>
                        <option value="21">翻译</option>
                        <option value="22">房地产/建筑</option>
                        <option value="23">航空航天</option>
                        <option value="24">家电业</option>
                        <option value="25">家居/室内设计</option>
                        <option value="26">教育/培训</option>
                        <option value="27">酒店</option>
                        <option value="28">会计</option>
                        <option value="29">科研/院校</option>
                        <option value="30">快速消费品</option>
                        <option value="31">零售</option>
                        <option value="32">旅游</option>
                ...
                <p class="form-list">
                    <label>爱好</label>
                    <input id="hobby" name="hobby" autocomplete="off" class="l_ipt" value="<?php echo ($user["hobbies"]); ?>" type="text">
                    <strong></strong>
                </p>
                <p class="form-list">
                    <label>微博地址</label>
                    <input id="weibo_add" name="weibo_add" autocomplete="off" class="l_ipt" value="<?php echo ($user["micro"]); ?>" type="text">
                    <strong></strong>
                </p>
                <p class="form-list">
                    <label>美丽宣言</label>
                    <textarea id="beauty" name="beauty"><?php echo ($user["declaration"]); ?></textarea>
                    <strong></strong>
                </p>
                <p class="setting_success"></p>
                <input value="确 认" class="ext_submit" type="submit">
            </form>
...
<!-- <script type="text/javascript" src="/Project/Mls/Home/Public/Js/jquery-1.8.3.min.js" charset="UTF-8"></script> -->

<script type="text/javascript" src="/Project/Mls/Home/Public/Js/bootstrap.min.js"></script>
<script type="text/javascript" src="/Project/Mls/Home/Public/Js/bootstrap-datetimepicker.js" charset="UTF-8"></script>
<script type="text/javascript" src="/Project/Mls/Home/Public/Js/bootstrap-datetimepicker.fr.js" charset="UTF-8"></script>
<script type="text/javascript" src="/Project/Mls/Home/Public/Js/bootstrap-datetimepicker.zh-CN.js" charset="UTF-8"></script>
