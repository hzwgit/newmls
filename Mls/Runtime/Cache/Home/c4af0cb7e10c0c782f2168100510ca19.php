...
<div class="status">
	...
	<script type="text/javascript">
		...
		$('#charge').click(function(){
			...
			$.post("<?php echo U(makeorder);?>",{textarea:$textarea,r_id:$r_id,shopid:$shopid,goodsid:$goodsid,num:$num},function(arg){
				//alert(arg);
			if(arg){
				//alert(arg);
...
<input type="hidden" id="color" value="<?php echo ($size); ?>"> -->
	...
	<table cellpadding="0" cellspacing="0">
		...
		<tbody class="shop">
			...
			<tr>
				<td class="shop_title" colspan="6">
					<span>
						商家：
						<a class="red_f" href="http://localhost/Project8.3/index.php/Home/Shopinfo/index/id/<?php echo ($goodsid); ?>" target="_blank"><?php echo ($shopname); ?></a>
					</span>
		...
		<tbody class="goods">
			<tr class="first last" id="goods_1539382398">
				<td class="first"></td>
				<td class="content">
					<a class="content-link" target="_blank" href="http://localhost/Project/index.php/Home/Shopinfo/index/id/<?php echo ($goodsid); ?>">
						<img src="/Project/Public<?php echo ($goodspic); ?>">
						<span class="title"><?php echo ($goodsname); ?></span>
						<span class="props">
				...
				<td>
					<div class="u_price"><?php echo ($goodsprice); ?></div>
				</td>
				<td><?php echo ($num); ?></td>
				<td><?php echo ($num*$goodsprice); ?></td>
				<td class="last"></td>
			</tr>
			<tr class="total">
				<td class="first"></td>
			...
			<tr class="total">
				...
				<td colspan="2" class="shop_total">
					...
					<span>
						店铺合计：
						<span id="shop_total_price_179168" class="price"><?php echo ($num*$goodsprice); ?></span>
						元
					</span>
				</td>
				<td class="last"></td>
			...
			<tr>
				...
				<td colspan="5" class="last">
					...
					<!-- 	<a class="cart" href="http://order.meilishuo.com/cart/?select_sid=1539382400_1539382398">&lt;&lt;返回购物车</a> -->
						...
						<span class="price">
							￥
							<span id="total_price"><?php echo ($num*$goodsprice); ?></span>
						</span>
