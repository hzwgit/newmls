<?php if (!defined('THINK_PATH')) exit();?><!-- <link rel="stylesheet" href="/Project/Mls/Store/Public/Css/login.css" media="all"> -->

<!--加载文件-->
<link rel="stylesheet" href="/Project/Mls/Store/Public/Css/base.css" media="all">
<link rel="stylesheet" href="/Project/Mls/Store/Public/Css/login.css" media="all">
  <meta charset="utf-8" />
<div class="wrap">
	<div class="reg_wrap">
		<div class="head">
			<a href="/Project/index.php/Home/Index/index" class="reg_logo"></a>
			<a href="/" class="welcome_txt"></a>
		</div>
		<div class="main">
			<div class="ad_wrap">
				<img src="/Project/Mls/Store/Public/Images/register/ad_img.jpg" height="353" width="370"></div>
...
<script type="text/javascript" src="/Project/Mls/Store/Public/Js/logins.js"></script>
<div class="login_form">
	<input type="hidden" id="hidden" value="<?php echo ($Login["flag"]); ?>">
				<form id="loginForm" method="post"  action="<?php echo U('Login/dologins');?>">
					<h3>
						<a href="/Project/index.php/Home/Login/index">注册</a>
						登录美丽说商家平台
					</h3>
					...
					<div id="veri"class="login_list authcode none_f">
						<div class="login_box">
							...
							<div class="checkImage" onselectstart="return false;">
								<img src="/Project/index.php/Store/Login/showVerify" onclick="if(this.src!=this.src+'?'+Math.random()) this.src=this.src+'?'+Math.random();"/>
