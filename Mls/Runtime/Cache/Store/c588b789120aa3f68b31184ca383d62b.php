...
<head>
	...
	<link rel="stylesheet" type="text/css" href="/Project/Mls/Store/Public/Css/base.css">
	<link rel="apple-touch-icon-precomposed" href="http://i.meilishuo.net/css/images/custom_icon_precomposed.png">
	<link rel="stylesheet" type="text/css" href="/Project/Mls/Store/Public/Css/simple.css">
...
<body>
	<div id="im_body" class="user_model" path-id="<?php echo (session('hid')); ?>">
		<div class="im_banner">
			...
			<div class="im_userlist">
				<div class="user_list" id="user_list">
					<div class="list_now" id="list_now">
						<div class="user_info   online" uid="185882563" style="display: block;">
						<!--
							<p class="user_status">
								<span class="simple_online">&nbsp;</span>
							</p>
							<p class="user_name">
								<span>E韩版时尚:E韩版时尚</span>
							</p>
							<span class="num"></span>
							<span class="closeBtn" style="display: none;">×</span>
						</div>
						<div class="user_info online" uid="" style="display: block;">
							<p class="user_status">
								<span class="simple_online">&nbsp;</span>
							</p>
							<p class="user_name">
		...
		<div class="im_main" id="im_main">
			...
			<!--潮包优品:潮包优品-->
			<div class="im_mainitem rightHide act" uid="">
				<div class="im_top">
					<div class="user_info online" uid="">
						<span class="user_img">
							<img class="shopImage" src="">
							<span class="mobile_online" style="display: none;"></span>
						</span>
						<div class="user_name" uid="">
				...
				<div class="im_mainbox">
					<div class="im_dialogbox">
						<div class="im_dialog" uid="">
							<div class="history">
								<div toid="" class="historyBtn" style="display: none;">查看历史聊天记录</div>
								<!--聊天内容-->
					...
					<div class="im_inputbox">
						...
						<!--现聊天内容-->
						<form method="post" onsubmit="return false" action="" uid="">
							<div class="im_inputbox_input" contenteditable="true"></div>
							<ul class="im_inputbox_picbox"></ul>
							<p class="button">
								<input class="btn sentBtn" type="submit" value="发 送"></p>
...
<script>
		var $u_id = '<?php echo (session('sid')); ?>';//店铺用户id
		...
		$(function(){
			...
			$('.sentBtn').click(function(){
				$.get('<?php echo U("Store/actionK");?>',{action:'insertK',id:$str,message:$inputText.html(),time:new Date()},function(data){
					console.log(data);
					if(data == '1'){
						$inputText.html('');
						AutoUpdContent();
			...
			$('.closeBtn').live('click',function(){
				$(this).parent().remove();
				$.get('<?php echo U("Store/actionK");?>',{action:'updateK',id:$str,time:new Date()});
			})
		})
		//获取数据
		...
		function GetMessageRight(value, flag){
			...
			+'	<div class="user_info">'
			+'		<span class="user_img">'
			+'			<img src="' + '<?php echo ($userinfo['pic']); ?>' + '"></span>'
			+'		</div>'
			+'		<div class="bubble" id="">'
			+'			<p>' + value.message + '</p>'
			+'			<span class="shap"></span>'
...
/*
		...
		var $id = '<?php echo (session('hid')); ?>';// 用户id
		...
		$(function(){
			//插入数据
			$('.sentBtn').click(function(){
				$.get('<?php echo U("Share/actionK");?>',{action:'insertK',id:$str,message:$inputText.html(),time:new Date()},function(data){
					if(data == '1'){
						$inputText.html('');
						//GetMessageList();
						AutoUpdContent();
			...
			$('.closeBtn').live('click',function(){
				$(this).parent().remove();
				$.get('<?php echo U("Share/actionK");?>',{action:'updateK',id:$str,time:new Date()});
			})
		})
		...
		function GetListData(index, value, $index){
			...
			$message = '<div class="user_info ' + act + ' online" uid="' + value.id +'" index="' + index + '" style="display: block;">'
					+'	<p class="user_status">'
					+'		<span class="simple_online">&nbsp;</span>'
					+'	</p>'
					+'	<p class="user_name">'
